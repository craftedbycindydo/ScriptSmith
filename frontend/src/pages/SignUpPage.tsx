...
import { Eye, EyeOff, Loader2, Code2, Check, X, ArrowLeft } from 'lucide-react';
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              "Join thousands of developers coding online. Save your work and access advanced features."
            </p>
          </blockquote>
        </div>
      </div>
